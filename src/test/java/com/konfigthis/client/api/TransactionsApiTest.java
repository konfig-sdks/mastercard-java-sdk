...
public class TransactionsApiTest {
     ...
     */
    @Test
    public void get24MonthsHistoryAndGenerateReportTest() throws ApiException {
        ...
        TransactionsReportAck response = api.get24MonthsHistoryAndGenerateReport(customerId, toDate)
    ...
    public void getAllCustomerTransactionsTest() throws ApiException {
        ...
        String sort = null;
        Boolean includePending = null;
        Transactions response = api.getAllCustomerTransactions(customerId, fromDate, toDate)
                .start(start)
                .limit(limit)
                .sort(sort)
                .includePending(includePending)
    ...
    public void getByIdTest() throws ApiException {
        ...
        Transaction response = api.getById(customerId, transactionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getCustomerAccountTransactionsTest() throws ApiException {
        ...
        String sort = null;
        Boolean includePending = null;
        Transactions response = api.getCustomerAccountTransactions(customerId, accountId, fromDate, toDate)
                .start(start)
                .limit(limit)
                .sort(sort)
                .includePending(includePending)
