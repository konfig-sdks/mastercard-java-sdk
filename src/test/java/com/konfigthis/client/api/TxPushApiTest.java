...
public class TxPushApiTest {
    ...
    private static TxPushApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TxPushApi(apiClient);
    }
    ...
    public void deleteSubscriptionTest() throws ApiException {
        ...
        api.deleteSubscription(customerId, subscriptionId)
                .execute();
     ...
     */
    @Test
    public void disableNotificationsTest() throws ApiException {
        String customerId = null;
        String accountId = null;
        api.disableNotifications(customerId, accountId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void injectTestTransactionTest() throws ApiException {
        ...
        CreatedTestTxPushTransaction response = api.injectTestTransaction(description, amount, transactionDate, customerId, accountId)
                .status(status)
     ...
     */
    @Test
    public void subscribeNotificationsTest() throws ApiException {
        String callbackUrl = null;
        String customerId = null;
        String accountId = null;
        TxPushSubscriptions response = api.subscribeNotifications(callbackUrl, customerId, accountId)
                .execute();
        // TODO: test validations
    }
