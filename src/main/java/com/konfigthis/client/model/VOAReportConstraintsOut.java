...
public class VOAReportConstraintsOut {
  ...
  **/
   ...
   * @return the VOAReportConstraintsOut instance itself
   */
  public VOAReportConstraintsOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, voAReportConstraintsOut.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, voAReportConstraintsOut.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAReportConstraintsOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAReportConstraintsOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAReportConstraintsOut is not found in the empty JSON string", VOAReportConstraintsOut.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAReportConstraintsOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAReportConstraintsOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAReportConstraintsOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAReportConstraintsOut.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAReportConstraintsOut>() {
           @Override
           public void write(JsonWriter out, VOAReportConstraintsOut value) throws IOException {
           ...
           @Override
           public VOAReportConstraintsOut read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAReportConstraintsOut instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAReportConstraintsOut given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAReportConstraintsOut
  * @throws IOException if the JSON string is invalid with respect to VOAReportConstraintsOut
  */
  public static VOAReportConstraintsOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAReportConstraintsOut.class);
  }

 /**
  * Convert an instance of VOAReportConstraintsOut to an JSON string
  *
  * @return JSON string
  */
