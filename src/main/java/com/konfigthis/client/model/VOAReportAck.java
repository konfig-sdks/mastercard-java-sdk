 ...
 */
@ApiModel(description = "A VOA report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOAReportAck {
  ...
  **/
   ...
   * @return the VOAReportAck instance itself
   */
  public VOAReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voAReportAck.title) &&
        Objects.equals(this.id, voAReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, voAReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAReportAck is not found in the empty JSON string", VOAReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VOAReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAReportAck>() {
           @Override
           public void write(JsonWriter out, VOAReportAck value) throws IOException {
           ...
           @Override
           public VOAReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAReportAck
  * @throws IOException if the JSON string is invalid with respect to VOAReportAck
  */
  public static VOAReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAReportAck.class);
  }

 /**
  * Convert an instance of VOAReportAck to an JSON string
  *
  * @return JSON string
  */
