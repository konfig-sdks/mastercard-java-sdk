 ...
 * A VOI report
 */
@ApiModel(description = "A VOI report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOIReport {
  ...
  **/
   ...
   * @return the VOIReport instance itself
   */
  public VOIReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voIReport.title) &&
        Objects.equals(this.id, voIReport.id) &&
        ...
        Objects.equals(this.additionalProperties, voIReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, startDate, endDate, days, seasoned, institutions, income, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOIReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOIReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOIReport is not found in the empty JSON string", VOIReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOIReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOIReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOIReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOIReport.class));

       return (TypeAdapter<T>) new TypeAdapter<VOIReport>() {
           @Override
           public void write(JsonWriter out, VOIReport value) throws IOException {
           ...
           @Override
           public VOIReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOIReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOIReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOIReport
  * @throws IOException if the JSON string is invalid with respect to VOIReport
  */
  public static VOIReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOIReport.class);
  }

 /**
  * Convert an instance of VOIReport to an JSON string
  *
  * @return JSON string
  */
