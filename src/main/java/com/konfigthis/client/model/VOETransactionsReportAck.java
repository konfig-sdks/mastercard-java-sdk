 ...
 */
@ApiModel(description = "A VOE Transactions report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOETransactionsReportAck {
  ...
  **/
   ...
   * @return the VOETransactionsReportAck instance itself
   */
  public VOETransactionsReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voETransactionsReportAck.title) &&
        Objects.equals(this.id, voETransactionsReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, voETransactionsReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOETransactionsReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOETransactionsReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOETransactionsReportAck is not found in the empty JSON string", VOETransactionsReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VOETransactionsReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOETransactionsReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOETransactionsReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOETransactionsReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOETransactionsReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<VOETransactionsReportAck>() {
           @Override
           public void write(JsonWriter out, VOETransactionsReportAck value) throws IOException {
           ...
           @Override
           public VOETransactionsReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOETransactionsReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOETransactionsReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOETransactionsReportAck
  * @throws IOException if the JSON string is invalid with respect to VOETransactionsReportAck
  */
  public static VOETransactionsReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOETransactionsReportAck.class);
  }

 /**
  * Convert an instance of VOETransactionsReportAck to an JSON string
  *
  * @return JSON string
  */
