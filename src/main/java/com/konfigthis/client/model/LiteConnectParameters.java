...
public class LiteConnectParameters {
  ...
  **/
   ...
   * @return the LiteConnectParameters instance itself
   */
  public LiteConnectParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, liteConnectParameters.language) &&
        ...
        Objects.equals(this.additionalProperties, liteConnectParameters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, partnerId, customerId, institutionId, redirectUri, webhook, webhookContentType, webhookData, webhookHeaders, experience, singleUseUrl, isWebView, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LiteConnectParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LiteConnectParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiteConnectParameters is not found in the empty JSON string", LiteConnectParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LiteConnectParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiteConnectParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiteConnectParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiteConnectParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiteConnectParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<LiteConnectParameters>() {
           @Override
           public void write(JsonWriter out, LiteConnectParameters value) throws IOException {
           ...
           @Override
           public LiteConnectParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LiteConnectParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LiteConnectParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LiteConnectParameters
  * @throws IOException if the JSON string is invalid with respect to LiteConnectParameters
  */
  public static LiteConnectParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiteConnectParameters.class);
  }

 /**
  * Convert an instance of LiteConnectParameters to an JSON string
  *
  * @return JSON string
  */
