 ...
 */
@ApiModel(description = "A Prequalification report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PrequalificationReport {
  ...
  **/
  ...
  public PrequalificationReport consolidatedAvailableBalance(Double consolidatedAvailableBalance) {
  ...
  public PrequalificationReport consolidatedAvailableBalance(Integer consolidatedAvailableBalance) {
  ...
  **/
   ...
   * @return the PrequalificationReport instance itself
   */
  public PrequalificationReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, prequalificationReport.title) &&
        Objects.equals(this.id, prequalificationReport.id) &&
        ...
        Objects.equals(this.additionalProperties, prequalificationReport.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrequalificationReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrequalificationReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrequalificationReport is not found in the empty JSON string", PrequalificationReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrequalificationReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrequalificationReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrequalificationReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrequalificationReport.class));

       return (TypeAdapter<T>) new TypeAdapter<PrequalificationReport>() {
           @Override
           public void write(JsonWriter out, PrequalificationReport value) throws IOException {
           ...
           @Override
           public PrequalificationReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrequalificationReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrequalificationReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrequalificationReport
  * @throws IOException if the JSON string is invalid with respect to PrequalificationReport
  */
  public static PrequalificationReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrequalificationReport.class);
  }

 /**
  * Convert an instance of PrequalificationReport to an JSON string
  *
  * @return JSON string
  */
