...
public class PaystubMonthlyIncomeRecord {
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyBasePay(Double estimatedMonthlyBasePay) {
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyBasePay(Integer estimatedMonthlyBasePay) {
  ...
  **/
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyOvertimePay(Double estimatedMonthlyOvertimePay) {
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyOvertimePay(Integer estimatedMonthlyOvertimePay) {
  ...
  **/
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyBonusPay(Double estimatedMonthlyBonusPay) {
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyBonusPay(Integer estimatedMonthlyBonusPay) {
  ...
  **/
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyCommissionPay(Double estimatedMonthlyCommissionPay) {
  ...
  public PaystubMonthlyIncomeRecord estimatedMonthlyCommissionPay(Integer estimatedMonthlyCommissionPay) {
  ...
  **/
   ...
   * @return the PaystubMonthlyIncomeRecord instance itself
   */
  public PaystubMonthlyIncomeRecord putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.estimatedMonthlyBasePay, paystubMonthlyIncomeRecord.estimatedMonthlyBasePay) &&
        ...
        Objects.equals(this.additionalProperties, paystubMonthlyIncomeRecord.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(estimatedMonthlyBasePay, estimatedMonthlyOvertimePay, estimatedMonthlyBonusPay, estimatedMonthlyCommissionPay, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaystubMonthlyIncomeRecord
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaystubMonthlyIncomeRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaystubMonthlyIncomeRecord is not found in the empty JSON string", PaystubMonthlyIncomeRecord.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaystubMonthlyIncomeRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaystubMonthlyIncomeRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaystubMonthlyIncomeRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaystubMonthlyIncomeRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<PaystubMonthlyIncomeRecord>() {
           @Override
           public void write(JsonWriter out, PaystubMonthlyIncomeRecord value) throws IOException {
           ...
           @Override
           public PaystubMonthlyIncomeRecord read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaystubMonthlyIncomeRecord instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaystubMonthlyIncomeRecord given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaystubMonthlyIncomeRecord
  * @throws IOException if the JSON string is invalid with respect to PaystubMonthlyIncomeRecord
  */
  public static PaystubMonthlyIncomeRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaystubMonthlyIncomeRecord.class);
  }

 /**
  * Convert an instance of PaystubMonthlyIncomeRecord to an JSON string
  *
  * @return JSON string
  */
