 ...
 */
@ApiModel(description = "Current estimated monthly pay for the employment.  This is a mandatory field only for VOIE-payroll report type.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MonthlyIncome {
  ...
  public MonthlyIncome estimatedMonthlyBasePay(Double estimatedMonthlyBasePay) {
  ...
  public MonthlyIncome estimatedMonthlyBasePay(Integer estimatedMonthlyBasePay) {
  ...
  **/
  ...
  @ApiModelProperty(example = "123.45", value = "Mastercard Open Banking estimated monthly base pay amount for the employment")
  ...
  public MonthlyIncome estimatedMonthlyOvertimePay(Double estimatedMonthlyOvertimePay) {
  ...
  public MonthlyIncome estimatedMonthlyOvertimePay(Integer estimatedMonthlyOvertimePay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123.45", value = "Mastercard Open Banking estimated monthly overtime pay amount for the employment")
  ...
  public MonthlyIncome estimatedMonthlyBonusPay(Double estimatedMonthlyBonusPay) {
  ...
  public MonthlyIncome estimatedMonthlyBonusPay(Integer estimatedMonthlyBonusPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123.45", value = "Mastercard Open Banking estimated monthly bonus pay amount for the employment")
  ...
  public MonthlyIncome estimatedMonthlyOtherPay(Double estimatedMonthlyOtherPay) {
  ...
  public MonthlyIncome estimatedMonthlyOtherPay(Integer estimatedMonthlyOtherPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123.45", value = "Mastercard Open Banking estimated monthly other pay amount for the employment")
  ...
  public MonthlyIncome estimatedMonthlyTotalPay(Double estimatedMonthlyTotalPay) {
  ...
  public MonthlyIncome estimatedMonthlyTotalPay(Integer estimatedMonthlyTotalPay) {
  ...
  **/
  ...
  @ApiModelProperty(example = "123.45", required = true, value = "Sum of all Mastercard Open Banking estimated monthly pay amounts")
  ...
  public MonthlyIncome estimatedMonthlyCommissionPay(Double estimatedMonthlyCommissionPay) {
  ...
  public MonthlyIncome estimatedMonthlyCommissionPay(Integer estimatedMonthlyCommissionPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123.45", value = "Mastercard Open Banking estimated monthly commission pay amount for the employment")
   ...
   * @return the MonthlyIncome instance itself
   */
  public MonthlyIncome putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.estimatedMonthlyBasePay, monthlyIncome.estimatedMonthlyBasePay) &&
        ...
        Objects.equals(this.additionalProperties, monthlyIncome.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(estimatedMonthlyBasePay, estimatedMonthlyOvertimePay, estimatedMonthlyBonusPay, estimatedMonthlyOtherPay, estimatedMonthlyTotalPay, estimatedMonthlyCommissionPay, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("estimatedMonthlyTotalPay");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MonthlyIncome
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MonthlyIncome.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonthlyIncome is not found in the empty JSON string", MonthlyIncome.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonthlyIncome.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonthlyIncome.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonthlyIncome' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonthlyIncome> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonthlyIncome.class));

       return (TypeAdapter<T>) new TypeAdapter<MonthlyIncome>() {
           @Override
           public void write(JsonWriter out, MonthlyIncome value) throws IOException {
           ...
           @Override
           public MonthlyIncome read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MonthlyIncome instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MonthlyIncome given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MonthlyIncome
  * @throws IOException if the JSON string is invalid with respect to MonthlyIncome
  */
  public static MonthlyIncome fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonthlyIncome.class);
  }

 /**
  * Convert an instance of MonthlyIncome to an JSON string
  *
  * @return JSON string
  */
