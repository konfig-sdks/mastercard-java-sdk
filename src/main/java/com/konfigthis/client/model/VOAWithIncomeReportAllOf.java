...
public class VOAWithIncomeReportAllOf {
  ...
  public VOAWithIncomeReportAllOf() {
  }

  public VOAWithIncomeReportAllOf startDate(Long startDate) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf endDate(Long endDate) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf days(Integer days) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf seasoned(Boolean seasoned) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf consolidatedAvailableBalance(Double consolidatedAvailableBalance) {
  ...
  public VOAWithIncomeReportAllOf consolidatedAvailableBalance(Integer consolidatedAvailableBalance) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf institutions(List<ReportInstitution> institutions) {
  ...
  public VOAWithIncomeReportAllOf addInstitutionsItem(ReportInstitution institutionsItem) {
  ...
  **/
  ...
  public VOAWithIncomeReportAllOf assets(PrequalificationReportAssetSummary assets) {
  ...
  **/
   ...
   * @return the VOAWithIncomeReportAllOf instance itself
   */
  public VOAWithIncomeReportAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VOAWithIncomeReportAllOf voAWithIncomeReportAllOf = (VOAWithIncomeReportAllOf) o;
    return Objects.equals(this.startDate, voAWithIncomeReportAllOf.startDate) &&
        Objects.equals(this.endDate, voAWithIncomeReportAllOf.endDate) &&
        Objects.equals(this.days, voAWithIncomeReportAllOf.days) &&
        Objects.equals(this.seasoned, voAWithIncomeReportAllOf.seasoned) &&
        Objects.equals(this.consolidatedAvailableBalance, voAWithIncomeReportAllOf.consolidatedAvailableBalance) &&
        Objects.equals(this.institutions, voAWithIncomeReportAllOf.institutions) &&
        Objects.equals(this.assets, voAWithIncomeReportAllOf.assets)&&
        Objects.equals(this.additionalProperties, voAWithIncomeReportAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VOAWithIncomeReportAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAWithIncomeReportAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAWithIncomeReportAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAWithIncomeReportAllOf is not found in the empty JSON string", VOAWithIncomeReportAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAWithIncomeReportAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAWithIncomeReportAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAWithIncomeReportAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAWithIncomeReportAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAWithIncomeReportAllOf>() {
           @Override
           public void write(JsonWriter out, VOAWithIncomeReportAllOf value) throws IOException {
           ...
           @Override
           public VOAWithIncomeReportAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAWithIncomeReportAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAWithIncomeReportAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAWithIncomeReportAllOf
  * @throws IOException if the JSON string is invalid with respect to VOAWithIncomeReportAllOf
  */
  public static VOAWithIncomeReportAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAWithIncomeReportAllOf.class);
  }

 /**
  * Convert an instance of VOAWithIncomeReportAllOf to an JSON string
  *
  * @return JSON string
  */
