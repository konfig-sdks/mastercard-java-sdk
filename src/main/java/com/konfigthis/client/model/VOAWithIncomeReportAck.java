 ...
 */
@ApiModel(description = "A VOA with income report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOAWithIncomeReportAck {
  ...
  **/
   ...
   * @return the VOAWithIncomeReportAck instance itself
   */
  public VOAWithIncomeReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voAWithIncomeReportAck.title) &&
        Objects.equals(this.id, voAWithIncomeReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, voAWithIncomeReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAWithIncomeReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAWithIncomeReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAWithIncomeReportAck is not found in the empty JSON string", VOAWithIncomeReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VOAWithIncomeReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAWithIncomeReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAWithIncomeReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAWithIncomeReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAWithIncomeReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAWithIncomeReportAck>() {
           @Override
           public void write(JsonWriter out, VOAWithIncomeReportAck value) throws IOException {
           ...
           @Override
           public VOAWithIncomeReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAWithIncomeReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAWithIncomeReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAWithIncomeReportAck
  * @throws IOException if the JSON string is invalid with respect to VOAWithIncomeReportAck
  */
  public static VOAWithIncomeReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAWithIncomeReportAck.class);
  }

 /**
  * Convert an instance of VOAWithIncomeReportAck to an JSON string
  *
  * @return JSON string
  */
