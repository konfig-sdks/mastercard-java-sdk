 ...
 * A VOA report
 */
@ApiModel(description = "A VOA report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOAReport {
  ...
  **/
  ...
  public VOAReport consolidatedAvailableBalance(Double consolidatedAvailableBalance) {
  ...
  public VOAReport consolidatedAvailableBalance(Integer consolidatedAvailableBalance) {
  ...
  **/
   ...
   * @return the VOAReport instance itself
   */
  public VOAReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voAReport.title) &&
        Objects.equals(this.id, voAReport.id) &&
        ...
        Objects.equals(this.additionalProperties, voAReport.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAReport is not found in the empty JSON string", VOAReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAReport.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAReport>() {
           @Override
           public void write(JsonWriter out, VOAReport value) throws IOException {
           ...
           @Override
           public VOAReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAReport
  * @throws IOException if the JSON string is invalid with respect to VOAReport
  */
  public static VOAReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAReport.class);
  }

 /**
  * Convert an instance of VOAReport to an JSON string
  *
  * @return JSON string
  */
