...
public class PayStatementForVoie {
  ...
  **/
  ...
  public PayStatementForVoie netPayCurrent(Double netPayCurrent) {
  ...
  public PayStatementForVoie netPayCurrent(Integer netPayCurrent) {
  ...
  **/
  ...
  public PayStatementForVoie netPayYTD(Double netPayYTD) {
  ...
  public PayStatementForVoie netPayYTD(Integer netPayYTD) {
  ...
  **/
  ...
  public PayStatementForVoie grossPayCurrent(Double grossPayCurrent) {
  ...
  public PayStatementForVoie grossPayCurrent(Integer grossPayCurrent) {
  ...
  **/
  ...
  public PayStatementForVoie grossPayYTD(Double grossPayYTD) {
  ...
  public PayStatementForVoie grossPayYTD(Integer grossPayYTD) {
  ...
  **/
   ...
   * @return the PayStatementForVoie instance itself
   */
  public PayStatementForVoie putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payPeriod, payStatementForVoie.payPeriod) &&
        ...
        Objects.equals(this.additionalProperties, payStatementForVoie.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payPeriod, billable, assetId, payDate, startDate, endDate, netPayCurrent, netPayYTD, grossPayCurrent, grossPayYTD, payrollProvider, employer, employee, payStat, directDeposits, institutions, errorCode, errorMessage, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayStatementForVoie
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayStatementForVoie.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayStatementForVoie is not found in the empty JSON string", PayStatementForVoie.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayStatementForVoie.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayStatementForVoie.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayStatementForVoie' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayStatementForVoie> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayStatementForVoie.class));

       return (TypeAdapter<T>) new TypeAdapter<PayStatementForVoie>() {
           @Override
           public void write(JsonWriter out, PayStatementForVoie value) throws IOException {
           ...
           @Override
           public PayStatementForVoie read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayStatementForVoie instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayStatementForVoie given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayStatementForVoie
  * @throws IOException if the JSON string is invalid with respect to PayStatementForVoie
  */
  public static PayStatementForVoie fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayStatementForVoie.class);
  }

 /**
  * Convert an instance of PayStatementForVoie to an JSON string
  *
  * @return JSON string
  */
