...
public class VOIReportConstraintsOut {
  ...
  **/
   ...
   * @return the VOIReportConstraintsOut instance itself
   */
  public VOIReportConstraintsOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, voIReportConstraintsOut.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, voIReportConstraintsOut.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOIReportConstraintsOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOIReportConstraintsOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOIReportConstraintsOut is not found in the empty JSON string", VOIReportConstraintsOut.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOIReportConstraintsOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOIReportConstraintsOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOIReportConstraintsOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOIReportConstraintsOut.class));

       return (TypeAdapter<T>) new TypeAdapter<VOIReportConstraintsOut>() {
           @Override
           public void write(JsonWriter out, VOIReportConstraintsOut value) throws IOException {
           ...
           @Override
           public VOIReportConstraintsOut read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOIReportConstraintsOut instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOIReportConstraintsOut given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOIReportConstraintsOut
  * @throws IOException if the JSON string is invalid with respect to VOIReportConstraintsOut
  */
  public static VOIReportConstraintsOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOIReportConstraintsOut.class);
  }

 /**
  * Convert an instance of VOIReportConstraintsOut to an JSON string
  *
  * @return JSON string
  */
