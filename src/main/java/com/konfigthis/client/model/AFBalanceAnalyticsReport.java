 ...
 */
@ApiModel(description = "A Balance Analytics Report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AFBalanceAnalyticsReport {
  ...
  **/
  ...
  public AFBalanceAnalyticsReport constraints(AnalyticsReportConstraintsOut constraints) {
  ...
  **/
   ...
   * @return the AFBalanceAnalyticsReport instance itself
   */
  public AFBalanceAnalyticsReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, afBalanceAnalyticsReport.title) &&
        Objects.equals(this.id, afBalanceAnalyticsReport.id) &&
        ...
        Objects.equals(this.additionalProperties, afBalanceAnalyticsReport.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AFBalanceAnalyticsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AFBalanceAnalyticsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AFBalanceAnalyticsReport is not found in the empty JSON string", AFBalanceAnalyticsReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AFBalanceAnalyticsReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AFBalanceAnalyticsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AFBalanceAnalyticsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AFBalanceAnalyticsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AFBalanceAnalyticsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<AFBalanceAnalyticsReport>() {
           @Override
           public void write(JsonWriter out, AFBalanceAnalyticsReport value) throws IOException {
           ...
           @Override
           public AFBalanceAnalyticsReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AFBalanceAnalyticsReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AFBalanceAnalyticsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AFBalanceAnalyticsReport
  * @throws IOException if the JSON string is invalid with respect to AFBalanceAnalyticsReport
  */
  public static AFBalanceAnalyticsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AFBalanceAnalyticsReport.class);
  }

 /**
  * Convert an instance of AFBalanceAnalyticsReport to an JSON string
  *
  * @return JSON string
  */
