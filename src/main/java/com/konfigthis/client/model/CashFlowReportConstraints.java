...
public class CashFlowReportConstraints {
  ...
  **/
   ...
   * @return the CashFlowReportConstraints instance itself
   */
  public CashFlowReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, cashFlowReportConstraints.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, cashFlowReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashFlowReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashFlowReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashFlowReportConstraints is not found in the empty JSON string", CashFlowReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashFlowReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashFlowReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashFlowReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashFlowReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<CashFlowReportConstraints>() {
           @Override
           public void write(JsonWriter out, CashFlowReportConstraints value) throws IOException {
           ...
           @Override
           public CashFlowReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CashFlowReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CashFlowReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CashFlowReportConstraints
  * @throws IOException if the JSON string is invalid with respect to CashFlowReportConstraints
  */
  public static CashFlowReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashFlowReportConstraints.class);
  }

 /**
  * Convert an instance of CashFlowReportConstraints to an JSON string
  *
  * @return JSON string
  */
