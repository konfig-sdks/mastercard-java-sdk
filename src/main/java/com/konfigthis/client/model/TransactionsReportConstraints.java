...
public class TransactionsReportConstraints {
  ...
  **/
   ...
   * @return the TransactionsReportConstraints instance itself
   */
  public TransactionsReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, transactionsReportConstraints.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, transactionsReportConstraints.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountIds, fromDate, reportCustomFields, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionsReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionsReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionsReportConstraints is not found in the empty JSON string", TransactionsReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionsReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionsReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionsReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionsReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionsReportConstraints>() {
           @Override
           public void write(JsonWriter out, TransactionsReportConstraints value) throws IOException {
           ...
           @Override
           public TransactionsReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionsReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionsReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionsReportConstraints
  * @throws IOException if the JSON string is invalid with respect to TransactionsReportConstraints
  */
  public static TransactionsReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionsReportConstraints.class);
  }

 /**
  * Convert an instance of TransactionsReportConstraints to an JSON string
  *
  * @return JSON string
  */
