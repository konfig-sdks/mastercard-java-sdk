...
public class VOAWithIncomeReportConstraints {
  ...
  **/
   ...
   * @return the VOAWithIncomeReportConstraints instance itself
   */
  public VOAWithIncomeReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, voAWithIncomeReportConstraints.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, voAWithIncomeReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAWithIncomeReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAWithIncomeReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAWithIncomeReportConstraints is not found in the empty JSON string", VOAWithIncomeReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAWithIncomeReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAWithIncomeReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAWithIncomeReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAWithIncomeReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAWithIncomeReportConstraints>() {
           @Override
           public void write(JsonWriter out, VOAWithIncomeReportConstraints value) throws IOException {
           ...
           @Override
           public VOAWithIncomeReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAWithIncomeReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAWithIncomeReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAWithIncomeReportConstraints
  * @throws IOException if the JSON string is invalid with respect to VOAWithIncomeReportConstraints
  */
  public static VOAWithIncomeReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAWithIncomeReportConstraints.class);
  }

 /**
  * Convert an instance of VOAWithIncomeReportConstraints to an JSON string
  *
  * @return JSON string
  */
