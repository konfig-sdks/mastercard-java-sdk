...
public class VOETransactionsReportConstraints {
  ...
  **/
   ...
   * @return the VOETransactionsReportConstraints instance itself
   */
  public VOETransactionsReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reportId, voETransactionsReportConstraints.reportId) &&
        ...
        Objects.equals(this.additionalProperties, voETransactionsReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOETransactionsReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOETransactionsReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOETransactionsReportConstraints is not found in the empty JSON string", VOETransactionsReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOETransactionsReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOETransactionsReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOETransactionsReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOETransactionsReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<VOETransactionsReportConstraints>() {
           @Override
           public void write(JsonWriter out, VOETransactionsReportConstraints value) throws IOException {
           ...
           @Override
           public VOETransactionsReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOETransactionsReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOETransactionsReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOETransactionsReportConstraints
  * @throws IOException if the JSON string is invalid with respect to VOETransactionsReportConstraints
  */
  public static VOETransactionsReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOETransactionsReportConstraints.class);
  }

 /**
  * Convert an instance of VOETransactionsReportConstraints to an JSON string
  *
  * @return JSON string
  */
