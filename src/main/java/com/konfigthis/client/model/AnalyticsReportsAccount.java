...
public class AnalyticsReportsAccount {
  ...
  **/
  ...
  public AnalyticsReportsAccount currentBalance(Double currentBalance) {
  ...
  public AnalyticsReportsAccount currentBalance(Integer currentBalance) {
  ...
  **/
  ...
  public AnalyticsReportsAccount availableBalance(Double availableBalance) {
  ...
  public AnalyticsReportsAccount availableBalance(Integer availableBalance) {
  ...
  **/
   ...
   * @return the AnalyticsReportsAccount instance itself
   */
  public AnalyticsReportsAccount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, analyticsReportsAccount.id) &&
        ...
        Objects.equals(this.additionalProperties, analyticsReportsAccount.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, ownerName, ownerAddress, name, number, type, aggregationStatusCode, currentBalance, availableBalance, balanceDate, transactions, details, accountAnalytics, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnalyticsReportsAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnalyticsReportsAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsReportsAccount is not found in the empty JSON string", AnalyticsReportsAccount.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnalyticsReportsAccount.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsReportsAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsReportsAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsReportsAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsReportsAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsReportsAccount>() {
           @Override
           public void write(JsonWriter out, AnalyticsReportsAccount value) throws IOException {
           ...
           @Override
           public AnalyticsReportsAccount read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnalyticsReportsAccount instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnalyticsReportsAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnalyticsReportsAccount
  * @throws IOException if the JSON string is invalid with respect to AnalyticsReportsAccount
  */
  public static AnalyticsReportsAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsReportsAccount.class);
  }

 /**
  * Convert an instance of AnalyticsReportsAccount to an JSON string
  *
  * @return JSON string
  */
