 ...
 * A list of customers
 */
@ApiModel(description = "A list of customers")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Customers {
  ...
  **/
  ...
  @ApiModelProperty(example = "200", value = "The total number of results matching search criteria")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of customer records")
   ...
   * @return the Customers instance itself
   */
  public Customers putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.found, customers.found) &&
        ...
        Objects.equals(this.additionalProperties, customers.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(found, displaying, moreAvailable, customers, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Customers>() {
           ...
           public Customers read(JsonReader in) throws IOException {
             ...
             Customers instance = thisAdapter.fromJsonTree(jsonObj);
