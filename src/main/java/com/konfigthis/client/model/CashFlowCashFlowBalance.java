...
import com.konfigthis.client.model.CashFlowMonthlyCashFlowBalances;
...
public class CashFlowCashFlowBalance {
  public static final String SERIALIZED_NAME_MONTHLY_CASH_FLOW_BALANCES = "monthlyCashFlowBalances";
  @SerializedName(SERIALIZED_NAME_MONTHLY_CASH_FLOW_BALANCES)
  ...
  public static final String SERIALIZED_NAME_NUMBER_DAYS_NEGATIVE_BALANCE = "numberDaysNegativeBalance";
  @SerializedName(SERIALIZED_NAME_NUMBER_DAYS_NEGATIVE_BALANCE)
  ...
  **/
  ...
  public CashFlowCashFlowBalance minDailyBalance(Double minDailyBalance) {
  ...
  public CashFlowCashFlowBalance minDailyBalance(Integer minDailyBalance) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3479.39", required = true, value = "Min daily balance across entire transaction history")
  ...
  public CashFlowCashFlowBalance maxDailyBalance(Double maxDailyBalance) {
  ...
  public CashFlowCashFlowBalance maxDailyBalance(Integer maxDailyBalance) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3479.39", required = true, value = "Max Daily Balance across entire transaction history")
  ...
  public CashFlowCashFlowBalance twelveMonthAverageDailyBalance(Double twelveMonthAverageDailyBalance) {
  ...
  public CashFlowCashFlowBalance twelveMonthAverageDailyBalance(Integer twelveMonthAverageDailyBalance) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3479.39", required = true, value = "Average Daily Balance across twelve months for the account")
  ...
  public CashFlowCashFlowBalance sixMonthAverageDailyBalance(Double sixMonthAverageDailyBalance) {
  ...
  public CashFlowCashFlowBalance sixMonthAverageDailyBalance(Integer sixMonthAverageDailyBalance) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3479.39", required = true, value = "Average Daily Balance across six months for the account")
  ...
  public CashFlowCashFlowBalance twoMonthAverageDailyBalance(Double twoMonthAverageDailyBalance) {
  ...
  public CashFlowCashFlowBalance twoMonthAverageDailyBalance(Integer twoMonthAverageDailyBalance) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3479.39", required = true, value = "Average Daily Balance across two months for the account")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "20", required = true, value = "Standard Deviation of Daily Balance across twelve months for the account")
  ...
  **/
  ...
  @ApiModelProperty(example = "20", value = "Standard Deviation of Daily Balance across six months for the account")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "20", required = true, value = "Standard Deviation of Daily Balance across two months for the account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6", value = "Number of Days Negative Balance over entire transaction history")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "0", required = true, value = "Number of Days positive balance over entire transaction history")
   ...
   * @return the CashFlowCashFlowBalance instance itself
   */
  public CashFlowCashFlowBalance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.monthlyCashFlowBalances, cashFlowCashFlowBalance.monthlyCashFlowBalances) &&
        ...
        Objects.equals(this.additionalProperties, cashFlowCashFlowBalance.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(monthlyCashFlowBalances, minDailyBalance, maxDailyBalance, twelveMonthAverageDailyBalance, sixMonthAverageDailyBalance, twoMonthAverageDailyBalance, twelveMonthStandardDeviationOfDailyBalance, sixMonthStandardDeviationOfDailyBalance, twoMonthStandardDeviationOfDailyBalance, numberDaysNegativeBalance, numberOfDaysPositiveBalance, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("monthlyCashFlowBalances");
    ...
    openapiFields.add("numberDaysNegativeBalance");
    openapiFields.add("numberOfDaysPositiveBalance");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("monthlyCashFlowBalances");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashFlowCashFlowBalance
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashFlowCashFlowBalance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashFlowCashFlowBalance is not found in the empty JSON string", CashFlowCashFlowBalance.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CashFlowCashFlowBalance.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("monthlyCashFlowBalances").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `monthlyCashFlowBalances` to be an array in the JSON string but got `%s`", jsonObj.get("monthlyCashFlowBalances").toString()));
      }

      JsonArray jsonArraymonthlyCashFlowBalances = jsonObj.getAsJsonArray("monthlyCashFlowBalances");
      // validate the required field `monthlyCashFlowBalances` (array)
      for (int i = 0; i < jsonArraymonthlyCashFlowBalances.size(); i++) {
        CashFlowMonthlyCashFlowBalances.validateJsonObject(jsonArraymonthlyCashFlowBalances.get(i).getAsJsonObject());
      };
      ...
      if ((jsonObj.get("numberDaysNegativeBalance") != null && !jsonObj.get("numberDaysNegativeBalance").isJsonNull()) && !jsonObj.get("numberDaysNegativeBalance").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `numberDaysNegativeBalance` to be a primitive type in the JSON string but got `%s`", jsonObj.get("numberDaysNegativeBalance").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashFlowCashFlowBalance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashFlowCashFlowBalance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashFlowCashFlowBalance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashFlowCashFlowBalance.class));

       return (TypeAdapter<T>) new TypeAdapter<CashFlowCashFlowBalance>() {
           @Override
           public void write(JsonWriter out, CashFlowCashFlowBalance value) throws IOException {
           ...
           @Override
           public CashFlowCashFlowBalance read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CashFlowCashFlowBalance instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CashFlowCashFlowBalance given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CashFlowCashFlowBalance
  * @throws IOException if the JSON string is invalid with respect to CashFlowCashFlowBalance
  */
  public static CashFlowCashFlowBalance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashFlowCashFlowBalance.class);
  }

 /**
  * Convert an instance of CashFlowCashFlowBalance to an JSON string
  *
  * @return JSON string
  */
