 ...
 */
@ApiModel(description = "Properties shared by all generated reports having a portfolio ID")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BaseReportAckWithPortfolioId {
  ...
  **/
   ...
   * @return the BaseReportAckWithPortfolioId instance itself
   */
  public BaseReportAckWithPortfolioId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, baseReportAckWithPortfolioId.title) &&
        Objects.equals(this.id, baseReportAckWithPortfolioId.id) &&
        ...
        Objects.equals(this.additionalProperties, baseReportAckWithPortfolioId.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BaseReportAckWithPortfolioId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BaseReportAckWithPortfolioId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseReportAckWithPortfolioId is not found in the empty JSON string", BaseReportAckWithPortfolioId.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseReportAckWithPortfolioId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseReportAckWithPortfolioId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseReportAckWithPortfolioId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseReportAckWithPortfolioId.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseReportAckWithPortfolioId>() {
           @Override
           public void write(JsonWriter out, BaseReportAckWithPortfolioId value) throws IOException {
           ...
           @Override
           public BaseReportAckWithPortfolioId read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BaseReportAckWithPortfolioId instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BaseReportAckWithPortfolioId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BaseReportAckWithPortfolioId
  * @throws IOException if the JSON string is invalid with respect to BaseReportAckWithPortfolioId
  */
  public static BaseReportAckWithPortfolioId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseReportAckWithPortfolioId.class);
  }

 /**
  * Convert an instance of BaseReportAckWithPortfolioId to an JSON string
  *
  * @return JSON string
  */
