 ...
 */
@ApiModel(description = "A VOI report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOIReportAck {
  ...
  **/
   ...
   * @return the VOIReportAck instance itself
   */
  public VOIReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voIReportAck.title) &&
        Objects.equals(this.id, voIReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, voIReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOIReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOIReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOIReportAck is not found in the empty JSON string", VOIReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VOIReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOIReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOIReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOIReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOIReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<VOIReportAck>() {
           @Override
           public void write(JsonWriter out, VOIReportAck value) throws IOException {
           ...
           @Override
           public VOIReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOIReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOIReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOIReportAck
  * @throws IOException if the JSON string is invalid with respect to VOIReportAck
  */
  public static VOIReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOIReportAck.class);
  }

 /**
  * Convert an instance of VOIReportAck to an JSON string
  *
  * @return JSON string
  */
