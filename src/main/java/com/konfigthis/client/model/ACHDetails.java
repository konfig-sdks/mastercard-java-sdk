 ...
 */
@ApiModel(description = "The routing and account number information to initiate ACH transfers")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ACHDetails {
  public static final String SERIALIZED_NAME_ROUTING_NUMBER = "routingNumber";
  @SerializedName(SERIALIZED_NAME_ROUTING_NUMBER)
  private String routingNumber;

  public static final String SERIALIZED_NAME_REAL_ACCOUNT_NUMBER = "realAccountNumber";
  @SerializedName(SERIALIZED_NAME_REAL_ACCOUNT_NUMBER)
  ...
  **/
  ...
  @ApiModelProperty(example = "123456789", required = true, value = "The routing number of the financial institution for specific customer account")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "002345678901", required = true, value = "The account number for initiating ACH transfers for this account")
   ...
   * @return the ACHDetails instance itself
   */
  public ACHDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.routingNumber, acHDetails.routingNumber) &&
        ...
        Objects.equals(this.additionalProperties, acHDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(routingNumber, realAccountNumber, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("realAccountNumber");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("routingNumber");
    openapiRequiredFields.add("realAccountNumber");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ACHDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("realAccountNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `realAccountNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("realAccountNumber").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ACHDetails>() {
           ...
           public ACHDetails read(JsonReader in) throws IOException {
             ...
             ACHDetails instance = thisAdapter.fromJsonTree(jsonObj);
