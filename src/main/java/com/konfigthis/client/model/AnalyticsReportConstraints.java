...
public class AnalyticsReportConstraints {
  ...
  **/
   ...
   * @return the AnalyticsReportConstraints instance itself
   */
  public AnalyticsReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.analyticsReportData, analyticsReportConstraints.analyticsReportData) &&
        ...
        Objects.equals(this.additionalProperties, analyticsReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnalyticsReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnalyticsReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalyticsReportConstraints is not found in the empty JSON string", AnalyticsReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyticsReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyticsReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyticsReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyticsReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyticsReportConstraints>() {
           @Override
           public void write(JsonWriter out, AnalyticsReportConstraints value) throws IOException {
           ...
           @Override
           public AnalyticsReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnalyticsReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnalyticsReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnalyticsReportConstraints
  * @throws IOException if the JSON string is invalid with respect to AnalyticsReportConstraints
  */
  public static AnalyticsReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalyticsReportConstraints.class);
  }

 /**
  * Convert an instance of AnalyticsReportConstraints to an JSON string
  *
  * @return JSON string
  */
