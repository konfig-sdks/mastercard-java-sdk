 ...
 */
@ApiModel(description = "Properties shared by all generated reports")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BaseReportAck {
  ...
  **/
   ...
   * @return the BaseReportAck instance itself
   */
  public BaseReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, baseReportAck.title) &&
        Objects.equals(this.id, baseReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, baseReportAck.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BaseReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BaseReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseReportAck is not found in the empty JSON string", BaseReportAck.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseReportAck>() {
           @Override
           public void write(JsonWriter out, BaseReportAck value) throws IOException {
           ...
           @Override
           public BaseReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BaseReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BaseReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BaseReportAck
  * @throws IOException if the JSON string is invalid with respect to BaseReportAck
  */
  public static BaseReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseReportAck.class);
  }

 /**
  * Convert an instance of BaseReportAck to an JSON string
  *
  * @return JSON string
  */
