...
public class CashFlowReportAck {
  ...
  **/
   ...
   * @return the CashFlowReportAck instance itself
   */
  public CashFlowReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, cashFlowReportAck.title) &&
        Objects.equals(this.id, cashFlowReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, cashFlowReportAck.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, constraints, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashFlowReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashFlowReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashFlowReportAck is not found in the empty JSON string", CashFlowReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CashFlowReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashFlowReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashFlowReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashFlowReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashFlowReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<CashFlowReportAck>() {
           @Override
           public void write(JsonWriter out, CashFlowReportAck value) throws IOException {
           ...
           @Override
           public CashFlowReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CashFlowReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CashFlowReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CashFlowReportAck
  * @throws IOException if the JSON string is invalid with respect to CashFlowReportAck
  */
  public static CashFlowReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashFlowReportAck.class);
  }

 /**
  * Convert an instance of CashFlowReportAck to an JSON string
  *
  * @return JSON string
  */
