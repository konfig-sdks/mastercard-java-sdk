 ...
 */
@ApiModel(description = "A Pay Statement report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PayStatementReportAck {
  ...
  **/
   ...
   * @return the PayStatementReportAck instance itself
   */
  public PayStatementReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, payStatementReportAck.title) &&
        Objects.equals(this.id, payStatementReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, payStatementReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayStatementReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayStatementReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayStatementReportAck is not found in the empty JSON string", PayStatementReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayStatementReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayStatementReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayStatementReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayStatementReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayStatementReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<PayStatementReportAck>() {
           @Override
           public void write(JsonWriter out, PayStatementReportAck value) throws IOException {
           ...
           @Override
           public PayStatementReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayStatementReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayStatementReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayStatementReportAck
  * @throws IOException if the JSON string is invalid with respect to PayStatementReportAck
  */
  public static PayStatementReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayStatementReportAck.class);
  }

 /**
  * Convert an instance of PayStatementReportAck to an JSON string
  *
  * @return JSON string
  */
