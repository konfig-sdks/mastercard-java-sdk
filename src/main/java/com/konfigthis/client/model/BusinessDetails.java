...
public class BusinessDetails {
  ...
  **/
   ...
   * @return the BusinessDetails instance itself
   */
  public BusinessDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, businessDetails.name) &&
        ...
        Objects.equals(this.additionalProperties, businessDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, address, businessId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BusinessDetails>() {
           ...
           public BusinessDetails read(JsonReader in) throws IOException {
             ...
             BusinessDetails instance = thisAdapter.fromJsonTree(jsonObj);
