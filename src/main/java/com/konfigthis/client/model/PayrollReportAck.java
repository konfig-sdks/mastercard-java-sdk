 ...
 */
@ApiModel(description = "A Payroll report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PayrollReportAck {
  ...
  **/
   ...
   * @return the PayrollReportAck instance itself
   */
  public PayrollReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, payrollReportAck.title) &&
        Objects.equals(this.id, payrollReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, payrollReportAck.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, reportStyle, constraints, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayrollReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayrollReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayrollReportAck is not found in the empty JSON string", PayrollReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayrollReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayrollReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayrollReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayrollReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayrollReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<PayrollReportAck>() {
           @Override
           public void write(JsonWriter out, PayrollReportAck value) throws IOException {
           ...
           @Override
           public PayrollReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayrollReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayrollReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayrollReportAck
  * @throws IOException if the JSON string is invalid with respect to PayrollReportAck
  */
  public static PayrollReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayrollReportAck.class);
  }

 /**
  * Convert an instance of PayrollReportAck to an JSON string
  *
  * @return JSON string
  */
