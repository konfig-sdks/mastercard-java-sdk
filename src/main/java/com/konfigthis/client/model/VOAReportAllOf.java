...
public class VOAReportAllOf {
  ...
  public VOAReportAllOf() {
  }

  public VOAReportAllOf startDate(Long startDate) {
  ...
  **/
  ...
  public VOAReportAllOf endDate(Long endDate) {
  ...
  **/
  ...
  public VOAReportAllOf days(Integer days) {
  ...
  **/
  ...
  public VOAReportAllOf seasoned(Boolean seasoned) {
  ...
  **/
  ...
  public VOAReportAllOf consolidatedAvailableBalance(Double consolidatedAvailableBalance) {
  ...
  public VOAReportAllOf consolidatedAvailableBalance(Integer consolidatedAvailableBalance) {
  ...
  **/
  ...
  public VOAReportAllOf institutions(List<ReportInstitution> institutions) {
  ...
  public VOAReportAllOf addInstitutionsItem(ReportInstitution institutionsItem) {
  ...
  **/
  ...
  public VOAReportAllOf assets(PrequalificationReportAssetSummary assets) {
  ...
  **/
   ...
   * @return the VOAReportAllOf instance itself
   */
  public VOAReportAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VOAReportAllOf voAReportAllOf = (VOAReportAllOf) o;
    return Objects.equals(this.startDate, voAReportAllOf.startDate) &&
        Objects.equals(this.endDate, voAReportAllOf.endDate) &&
        Objects.equals(this.days, voAReportAllOf.days) &&
        Objects.equals(this.seasoned, voAReportAllOf.seasoned) &&
        Objects.equals(this.consolidatedAvailableBalance, voAReportAllOf.consolidatedAvailableBalance) &&
        Objects.equals(this.institutions, voAReportAllOf.institutions) &&
        Objects.equals(this.assets, voAReportAllOf.assets)&&
        Objects.equals(this.additionalProperties, voAReportAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VOAReportAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAReportAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAReportAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAReportAllOf is not found in the empty JSON string", VOAReportAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAReportAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAReportAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAReportAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAReportAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAReportAllOf>() {
           @Override
           public void write(JsonWriter out, VOAReportAllOf value) throws IOException {
           ...
           @Override
           public VOAReportAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAReportAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAReportAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAReportAllOf
  * @throws IOException if the JSON string is invalid with respect to VOAReportAllOf
  */
  public static VOAReportAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAReportAllOf.class);
  }

 /**
  * Convert an instance of VOAReportAllOf to an JSON string
  *
  * @return JSON string
  */
