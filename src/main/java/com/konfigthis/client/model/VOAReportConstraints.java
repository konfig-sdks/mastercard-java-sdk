...
public class VOAReportConstraints {
  ...
  **/
   ...
   * @return the VOAReportConstraints instance itself
   */
  public VOAReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, voAReportConstraints.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, voAReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOAReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOAReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOAReportConstraints is not found in the empty JSON string", VOAReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOAReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOAReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOAReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOAReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<VOAReportConstraints>() {
           @Override
           public void write(JsonWriter out, VOAReportConstraints value) throws IOException {
           ...
           @Override
           public VOAReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOAReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOAReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOAReportConstraints
  * @throws IOException if the JSON string is invalid with respect to VOAReportConstraints
  */
  public static VOAReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOAReportConstraints.class);
  }

 /**
  * Convert an instance of VOAReportConstraints to an JSON string
  *
  * @return JSON string
  */
