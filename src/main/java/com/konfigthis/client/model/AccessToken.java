 ...
 */
@ApiModel(description = "A temporary access token to be passed in the `Finicity-App-Token` HTTP header of all subsequent API requests")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccessToken {
  ...
  **/
  ...
  @ApiModelProperty(example = "YBh22Sb9Es6e66Q7lWdt", required = true, value = "The access token value")
