 ...
 */
@ApiModel(description = "A finicity customer record with application info")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomerWithAppData {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "123456789", required = true, value = "`applicationId` value returned from the Get App Registration Status API and the partner assign the customers to. This cannot be changed once set. Only applicable in cases of partners with multiple registered applications. If the partner only has one app, this can usually be omitted. This field is populated after the app is in a status approved.")
  ...
  **/
   ...
   * @return the CustomerWithAppData instance itself
   */
  public CustomerWithAppData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customerWithAppData.id) &&
        ...
        Objects.equals(this.additionalProperties, customerWithAppData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, username, firstName, lastName, type, createdDate, lastModifiedDate, applicationId, applicationName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomerWithAppData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomerWithAppData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerWithAppData is not found in the empty JSON string", CustomerWithAppData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomerWithAppData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerWithAppData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerWithAppData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerWithAppData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerWithAppData.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerWithAppData>() {
           @Override
           public void write(JsonWriter out, CustomerWithAppData value) throws IOException {
           ...
           @Override
           public CustomerWithAppData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CustomerWithAppData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustomerWithAppData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomerWithAppData
  * @throws IOException if the JSON string is invalid with respect to CustomerWithAppData
  */
  public static CustomerWithAppData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerWithAppData.class);
  }

 /**
  * Convert an instance of CustomerWithAppData to an JSON string
  *
  * @return JSON string
  */
