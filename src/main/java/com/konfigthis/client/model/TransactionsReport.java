 ...
 */
@ApiModel(description = "A Transactions report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TransactionsReport {
  ...
  **/
   ...
   * @return the TransactionsReport instance itself
   */
  public TransactionsReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, transactionsReport.title) &&
        Objects.equals(this.id, transactionsReport.id) &&
        ...
        Objects.equals(this.additionalProperties, transactionsReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, startDate, endDate, days, seasoned, institutions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionsReport is not found in the empty JSON string", TransactionsReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionsReport>() {
           @Override
           public void write(JsonWriter out, TransactionsReport value) throws IOException {
           ...
           @Override
           public TransactionsReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionsReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionsReport
  * @throws IOException if the JSON string is invalid with respect to TransactionsReport
  */
  public static TransactionsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionsReport.class);
  }

 /**
  * Convert an instance of TransactionsReport to an JSON string
  *
  * @return JSON string
  */
