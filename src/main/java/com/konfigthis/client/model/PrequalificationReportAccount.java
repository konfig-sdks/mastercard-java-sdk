...
public class PrequalificationReportAccount {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "JOHN DOE", value = "The name of the account owner. If no owner information is available, this field won't appear in the report.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123 GAINSVILLE STREET BUFORD, GA 84937", value = "The mailing address of the account owner. If no owner information is available, this field won't appear in the report.")
  ...
  **/
  ...
  public PrequalificationReportAccount balance(Double balance) {
  ...
  public PrequalificationReportAccount balance(Integer balance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1588350276", value = "A timestamp of the balance")
  ...
  public PrequalificationReportAccount availableBalance(Double availableBalance) {
  ...
  public PrequalificationReportAccount availableBalance(Integer availableBalance) {
  ...
  **/
  ...
  public PrequalificationReportAccount averageMonthlyBalance(Double averageMonthlyBalance) {
  ...
  public PrequalificationReportAccount averageMonthlyBalance(Integer averageMonthlyBalance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "501.02", value = "The average monthly balance of the account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "120", value = "The total number of days since the most recent insufficient funds fee for the account")
  ...
  **/
   ...
   * @return the PrequalificationReportAccount instance itself
   */
  public PrequalificationReportAccount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, prequalificationReportAccount.id) &&
        ...
        Objects.equals(this.additionalProperties, prequalificationReportAccount.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, number, ownerName, ownerAddress, name, type, aggregationStatusCode, balance, balanceDate, availableBalance, averageMonthlyBalance, totNumberInsufficientFundsFeeDebitTxAccount, totNumberInsufficientFundsFeeDebitTxOver6MonthsAccount, totNumberDaysSinceMostRecentInsufficientFundsFeeDebitTxAccount, transactions, asset, details, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrequalificationReportAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrequalificationReportAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrequalificationReportAccount is not found in the empty JSON string", PrequalificationReportAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        AccountDetails.validateJsonObject(jsonObj.getAsJsonObject("details"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrequalificationReportAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrequalificationReportAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrequalificationReportAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrequalificationReportAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<PrequalificationReportAccount>() {
           @Override
           public void write(JsonWriter out, PrequalificationReportAccount value) throws IOException {
           ...
           @Override
           public PrequalificationReportAccount read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrequalificationReportAccount instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrequalificationReportAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrequalificationReportAccount
  * @throws IOException if the JSON string is invalid with respect to PrequalificationReportAccount
  */
  public static PrequalificationReportAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrequalificationReportAccount.class);
  }

 /**
  * Convert an instance of PrequalificationReportAccount to an JSON string
  *
  * @return JSON string
  */
