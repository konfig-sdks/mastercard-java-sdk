 ...
 */
@ApiModel(description = "A Statement report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StatementReportAck {
  ...
  **/
   ...
   * @return the StatementReportAck instance itself
   */
  public StatementReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, statementReportAck.title) &&
        Objects.equals(this.id, statementReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, statementReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatementReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatementReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatementReportAck is not found in the empty JSON string", StatementReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatementReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatementReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatementReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatementReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatementReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<StatementReportAck>() {
           @Override
           public void write(JsonWriter out, StatementReportAck value) throws IOException {
           ...
           @Override
           public StatementReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StatementReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StatementReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StatementReportAck
  * @throws IOException if the JSON string is invalid with respect to StatementReportAck
  */
  public static StatementReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatementReportAck.class);
  }

 /**
  * Convert an instance of StatementReportAck to an JSON string
  *
  * @return JSON string
  */
