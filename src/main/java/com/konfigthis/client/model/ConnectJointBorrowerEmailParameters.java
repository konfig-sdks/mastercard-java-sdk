...
public class ConnectJointBorrowerEmailParameters {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "default", required = true, value = "The `experience` field allows you to customize: * Brand: color and logo * Icon: displayed on the \"Share your data\" page * Popular institutions: displayed on the Bank Search page * Report: the credit decisioning report to send when Connect completes. * MVS modules: financial, payroll, paystub  Note: the Finicity sales engineers (SE) help you set up a default experience for your company when you migrate to Connect 2.0. For each additional experience you create thereafter, they'll give you a unique ID. See [Generate Connect URL](https://developer.mastercard.com/open-banking-us/documentation/connect/generate-2-connect-url-apis/).  Experience values options: * \"default\": your default experience (must be defined) * GUID: the code for a different experience * Not defined: If you don't pass the experience parameter, then Connect's out of the box default experience (add accounts but no branding) is used, and the MVS modules will not run.")
  ...
  **/
   ...
   * @return the ConnectJointBorrowerEmailParameters instance itself
   */
  public ConnectJointBorrowerEmailParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, connectJointBorrowerEmailParameters.language) &&
        ...
        Objects.equals(this.additionalProperties, connectJointBorrowerEmailParameters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, partnerId, borrowers, redirectUri, webhook, webhookContentType, webhookData, webhookHeaders, institutionSettings, email, experience, fromDate, reportCustomFields, singleUseUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectJointBorrowerEmailParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectJointBorrowerEmailParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectJointBorrowerEmailParameters is not found in the empty JSON string", ConnectJointBorrowerEmailParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectJointBorrowerEmailParameters.openapiRequiredFields) {
      ...
      EmailOptions.validateJsonObject(jsonObj.getAsJsonObject("email"));
      if (!jsonObj.get("experience").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectJointBorrowerEmailParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectJointBorrowerEmailParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectJointBorrowerEmailParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectJointBorrowerEmailParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectJointBorrowerEmailParameters>() {
           @Override
           public void write(JsonWriter out, ConnectJointBorrowerEmailParameters value) throws IOException {
           ...
           @Override
           public ConnectJointBorrowerEmailParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectJointBorrowerEmailParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectJointBorrowerEmailParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectJointBorrowerEmailParameters
  * @throws IOException if the JSON string is invalid with respect to ConnectJointBorrowerEmailParameters
  */
  public static ConnectJointBorrowerEmailParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectJointBorrowerEmailParameters.class);
  }

 /**
  * Convert an instance of ConnectJointBorrowerEmailParameters to an JSON string
  *
  * @return JSON string
  */
