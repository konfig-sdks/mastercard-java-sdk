...
public class ReportTransactionNewTxBased {
  ...
  **/
  ...
  public ReportTransactionNewTxBased amount(Double amount) {
  ...
  public ReportTransactionNewTxBased amount(Integer amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "dividend", value = "Keywords in the description and memo fields were used to translate investment transactions into these types  * `cancel`  * `purchaseToClose`  * `purchaseToCover`  * `contribution`  * `optionExercise`  * `optionExpiration`  * `fee`  * `soldToClose`  * `soldToOpen`  * `split`  * `transfer`  * `returnOfCapital`  * `income`  * `purchased`  * `sold`  * `dividendReinvest`  * `dividend`  * `reinvestOfIncome`  * `interest`  * `deposit`  * `otherInfo` ")
  ...
  **/
  ...
  public ReportTransactionNewTxBased commission(Double commission) {
  ...
  public ReportTransactionNewTxBased commission(Integer commission) {
  ...
  **/
   ...
   * @return the ReportTransactionNewTxBased instance itself
   */
  public ReportTransactionNewTxBased putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, reportTransactionNewTxBased.description) &&
        Objects.equals(this.id, reportTransactionNewTxBased.id) &&
        ...
        Objects.equals(this.additionalProperties, reportTransactionNewTxBased.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, amount, postedDate, memo, investmentTransactionType, normalizedPayee, institutionTransactionId, category, type, securityType, symbol, commission, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportTransactionNewTxBased
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportTransactionNewTxBased.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportTransactionNewTxBased is not found in the empty JSON string", ReportTransactionNewTxBased.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportTransactionNewTxBased.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportTransactionNewTxBased.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportTransactionNewTxBased' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportTransactionNewTxBased> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportTransactionNewTxBased.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportTransactionNewTxBased>() {
           @Override
           public void write(JsonWriter out, ReportTransactionNewTxBased value) throws IOException {
           ...
           @Override
           public ReportTransactionNewTxBased read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReportTransactionNewTxBased instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReportTransactionNewTxBased given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportTransactionNewTxBased
  * @throws IOException if the JSON string is invalid with respect to ReportTransactionNewTxBased
  */
  public static ReportTransactionNewTxBased fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportTransactionNewTxBased.class);
  }

 /**
  * Convert an instance of ReportTransactionNewTxBased to an JSON string
  *
  * @return JSON string
  */
