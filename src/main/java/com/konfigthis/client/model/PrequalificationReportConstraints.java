...
public class PrequalificationReportConstraints {
  ...
  **/
   ...
   * @return the PrequalificationReportConstraints instance itself
   */
  public PrequalificationReportConstraints putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, prequalificationReportConstraints.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, prequalificationReportConstraints.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrequalificationReportConstraints
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrequalificationReportConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrequalificationReportConstraints is not found in the empty JSON string", PrequalificationReportConstraints.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrequalificationReportConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrequalificationReportConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrequalificationReportConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrequalificationReportConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<PrequalificationReportConstraints>() {
           @Override
           public void write(JsonWriter out, PrequalificationReportConstraints value) throws IOException {
           ...
           @Override
           public PrequalificationReportConstraints read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrequalificationReportConstraints instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrequalificationReportConstraints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrequalificationReportConstraints
  * @throws IOException if the JSON string is invalid with respect to PrequalificationReportConstraints
  */
  public static PrequalificationReportConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrequalificationReportConstraints.class);
  }

 /**
  * Convert an instance of PrequalificationReportConstraints to an JSON string
  *
  * @return JSON string
  */
