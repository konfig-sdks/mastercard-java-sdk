 ...
 */
@ApiModel(description = "A Prequalification report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PrequalificationReportAck {
  ...
  **/
   ...
   * @return the PrequalificationReportAck instance itself
   */
  public PrequalificationReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, prequalificationReportAck.title) &&
        Objects.equals(this.id, prequalificationReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, prequalificationReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrequalificationReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrequalificationReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrequalificationReportAck is not found in the empty JSON string", PrequalificationReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrequalificationReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrequalificationReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrequalificationReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrequalificationReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrequalificationReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<PrequalificationReportAck>() {
           @Override
           public void write(JsonWriter out, PrequalificationReportAck value) throws IOException {
           ...
           @Override
           public PrequalificationReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrequalificationReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrequalificationReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrequalificationReportAck
  * @throws IOException if the JSON string is invalid with respect to PrequalificationReportAck
  */
  public static PrequalificationReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrequalificationReportAck.class);
  }

 /**
  * Convert an instance of PrequalificationReportAck to an JSON string
  *
  * @return JSON string
  */
