...
public class AFBalanceAnalyticsReportAllOf {
  ...
  public AFBalanceAnalyticsReportAllOf() {
  }

  public AFBalanceAnalyticsReportAllOf startDate(Long startDate) {
  ...
  **/
  ...
  public AFBalanceAnalyticsReportAllOf endDate(Long endDate) {
  ...
  **/
  ...
  public AFBalanceAnalyticsReportAllOf days(Integer days) {
  ...
  **/
  ...
  public AFBalanceAnalyticsReportAllOf seasoned(Boolean seasoned) {
  ...
  **/
  ...
  public AFBalanceAnalyticsReportAllOf institutions(List<ReportInstitution> institutions) {
  ...
  public AFBalanceAnalyticsReportAllOf addInstitutionsItem(ReportInstitution institutionsItem) {
  ...
  **/
  ...
  public AFBalanceAnalyticsReportAllOf customerAnalytics(CustomerAnalytics customerAnalytics) {
  ...
  **/
   ...
   * @return the AFBalanceAnalyticsReportAllOf instance itself
   */
  public AFBalanceAnalyticsReportAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AFBalanceAnalyticsReportAllOf afBalanceAnalyticsReportAllOf = (AFBalanceAnalyticsReportAllOf) o;
    return Objects.equals(this.startDate, afBalanceAnalyticsReportAllOf.startDate) &&
        Objects.equals(this.endDate, afBalanceAnalyticsReportAllOf.endDate) &&
        Objects.equals(this.days, afBalanceAnalyticsReportAllOf.days) &&
        Objects.equals(this.seasoned, afBalanceAnalyticsReportAllOf.seasoned) &&
        Objects.equals(this.institutions, afBalanceAnalyticsReportAllOf.institutions) &&
        Objects.equals(this.customerAnalytics, afBalanceAnalyticsReportAllOf.customerAnalytics)&&
        Objects.equals(this.additionalProperties, afBalanceAnalyticsReportAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AFBalanceAnalyticsReportAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AFBalanceAnalyticsReportAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AFBalanceAnalyticsReportAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AFBalanceAnalyticsReportAllOf is not found in the empty JSON string", AFBalanceAnalyticsReportAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AFBalanceAnalyticsReportAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AFBalanceAnalyticsReportAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AFBalanceAnalyticsReportAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AFBalanceAnalyticsReportAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AFBalanceAnalyticsReportAllOf>() {
           @Override
           public void write(JsonWriter out, AFBalanceAnalyticsReportAllOf value) throws IOException {
           ...
           @Override
           public AFBalanceAnalyticsReportAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AFBalanceAnalyticsReportAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AFBalanceAnalyticsReportAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AFBalanceAnalyticsReportAllOf
  * @throws IOException if the JSON string is invalid with respect to AFBalanceAnalyticsReportAllOf
  */
  public static AFBalanceAnalyticsReportAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AFBalanceAnalyticsReportAllOf.class);
  }

 /**
  * Convert an instance of AFBalanceAnalyticsReportAllOf to an JSON string
  *
  * @return JSON string
  */
