...
public class CashFlowReportConstraintsOut {
  ...
  **/
   ...
   * @return the CashFlowReportConstraintsOut instance itself
   */
  public CashFlowReportConstraintsOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountIds, cashFlowReportConstraintsOut.accountIds) &&
        ...
        Objects.equals(this.additionalProperties, cashFlowReportConstraintsOut.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashFlowReportConstraintsOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashFlowReportConstraintsOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashFlowReportConstraintsOut is not found in the empty JSON string", CashFlowReportConstraintsOut.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashFlowReportConstraintsOut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashFlowReportConstraintsOut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashFlowReportConstraintsOut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashFlowReportConstraintsOut.class));

       return (TypeAdapter<T>) new TypeAdapter<CashFlowReportConstraintsOut>() {
           @Override
           public void write(JsonWriter out, CashFlowReportConstraintsOut value) throws IOException {
           ...
           @Override
           public CashFlowReportConstraintsOut read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CashFlowReportConstraintsOut instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CashFlowReportConstraintsOut given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CashFlowReportConstraintsOut
  * @throws IOException if the JSON string is invalid with respect to CashFlowReportConstraintsOut
  */
  public static CashFlowReportConstraintsOut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashFlowReportConstraintsOut.class);
  }

 /**
  * Convert an instance of CashFlowReportConstraintsOut to an JSON string
  *
  * @return JSON string
  */
