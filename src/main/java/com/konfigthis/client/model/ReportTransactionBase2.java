...
public class ReportTransactionBase2 {
  ...
  **/
  ...
  public ReportTransactionBase2 commission(Double commission) {
  ...
  public ReportTransactionBase2 commission(Integer commission) {
  ...
  **/
   ...
   * @return the ReportTransactionBase2 instance itself
   */
  public ReportTransactionBase2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.normalizedPayee, reportTransactionBase2.normalizedPayee) &&
        ...
        Objects.equals(this.additionalProperties, reportTransactionBase2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(normalizedPayee, institutionTransactionId, category, type, securityType, symbol, commission, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportTransactionBase2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportTransactionBase2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportTransactionBase2 is not found in the empty JSON string", ReportTransactionBase2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportTransactionBase2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportTransactionBase2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportTransactionBase2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportTransactionBase2.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportTransactionBase2>() {
           @Override
           public void write(JsonWriter out, ReportTransactionBase2 value) throws IOException {
           ...
           @Override
           public ReportTransactionBase2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReportTransactionBase2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReportTransactionBase2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportTransactionBase2
  * @throws IOException if the JSON string is invalid with respect to ReportTransactionBase2
  */
  public static ReportTransactionBase2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportTransactionBase2.class);
  }

 /**
  * Convert an instance of ReportTransactionBase2 to an JSON string
  *
  * @return JSON string
  */
