...
public class PayrollEmploymentHistoryVOIE {
  ...
  **/
  ...
  @ApiModelProperty(example = "123v3bv2s5n", value = "This is a Mastercard assigned ID to the employment record. It remains consistent for that employment record, even if the report is refreshed. It can be used to limit the employment records that are returned in the report.")
  ...
  **/
   ...
   * @return the PayrollEmploymentHistoryVOIE instance itself
   */
  public PayrollEmploymentHistoryVOIE putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asOfDate, payrollEmploymentHistoryVOIE.asOfDate) &&
        ...
        Objects.equals(this.additionalProperties, payrollEmploymentHistoryVOIE.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(asOfDate, employmentId, employerName, payrollSource, employee, employment, income, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayrollEmploymentHistoryVOIE
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayrollEmploymentHistoryVOIE.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayrollEmploymentHistoryVOIE is not found in the empty JSON string", PayrollEmploymentHistoryVOIE.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayrollEmploymentHistoryVOIE.openapiRequiredFields) {
      ...
      PayrollVOIEIncomeRecord.validateJsonObject(jsonObj.getAsJsonObject("income"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayrollEmploymentHistoryVOIE.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayrollEmploymentHistoryVOIE' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayrollEmploymentHistoryVOIE> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayrollEmploymentHistoryVOIE.class));

       return (TypeAdapter<T>) new TypeAdapter<PayrollEmploymentHistoryVOIE>() {
           @Override
           public void write(JsonWriter out, PayrollEmploymentHistoryVOIE value) throws IOException {
           ...
           @Override
           public PayrollEmploymentHistoryVOIE read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayrollEmploymentHistoryVOIE instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayrollEmploymentHistoryVOIE given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayrollEmploymentHistoryVOIE
  * @throws IOException if the JSON string is invalid with respect to PayrollEmploymentHistoryVOIE
  */
  public static PayrollEmploymentHistoryVOIE fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayrollEmploymentHistoryVOIE.class);
  }

 /**
  * Convert an instance of PayrollEmploymentHistoryVOIE to an JSON string
  *
  * @return JSON string
  */
