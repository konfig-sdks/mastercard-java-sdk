 ...
 * A Cash Flow report
 */
@ApiModel(description = "A Cash Flow report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CashFlowReport {
  ...
  **/
   ...
   * @return the CashFlowReport instance itself
   */
  public CashFlowReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, cashFlowReport.title) &&
        Objects.equals(this.id, cashFlowReport.id) &&
        ...
        Objects.equals(this.additionalProperties, cashFlowReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, startDate, endDate, days, seasoned, institutions, cashFlowBalanceSummary, cashFlowCreditSummary, cashFlowDebitSummary, cashFlowCharacteristicsSummary, possibleLoanDeposits, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashFlowReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashFlowReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashFlowReport is not found in the empty JSON string", CashFlowReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashFlowReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashFlowReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashFlowReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashFlowReport.class));

       return (TypeAdapter<T>) new TypeAdapter<CashFlowReport>() {
           @Override
           public void write(JsonWriter out, CashFlowReport value) throws IOException {
           ...
           @Override
           public CashFlowReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CashFlowReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CashFlowReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CashFlowReport
  * @throws IOException if the JSON string is invalid with respect to CashFlowReport
  */
  public static CashFlowReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashFlowReport.class);
  }

 /**
  * Convert an instance of CashFlowReport to an JSON string
  *
  * @return JSON string
  */
