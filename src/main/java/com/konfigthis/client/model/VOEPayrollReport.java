 ...
 */
@ApiModel(description = "A VOE Payroll report")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOEPayrollReport {
  ...
  **/
   ...
   * @return the VOEPayrollReport instance itself
   */
  public VOEPayrollReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voEPayrollReport.title) &&
        Objects.equals(this.id, voEPayrollReport.id) &&
        ...
        Objects.equals(this.additionalProperties, voEPayrollReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, customerType, customerId, requestId, requesterName, createdDate, consumerId, consumerSsn, type, status, errors, portfolioId, employmentHistory, gseEnabled, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOEPayrollReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOEPayrollReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOEPayrollReport is not found in the empty JSON string", VOEPayrollReport.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOEPayrollReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOEPayrollReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOEPayrollReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOEPayrollReport.class));

       return (TypeAdapter<T>) new TypeAdapter<VOEPayrollReport>() {
           @Override
           public void write(JsonWriter out, VOEPayrollReport value) throws IOException {
           ...
           @Override
           public VOEPayrollReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOEPayrollReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOEPayrollReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOEPayrollReport
  * @throws IOException if the JSON string is invalid with respect to VOEPayrollReport
  */
  public static VOEPayrollReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOEPayrollReport.class);
  }

 /**
  * Convert an instance of VOEPayrollReport to an JSON string
  *
  * @return JSON string
  */
