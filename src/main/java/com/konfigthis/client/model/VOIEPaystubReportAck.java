 ...
 */
@ApiModel(description = "A VOIE Paystub report being generated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VOIEPaystubReportAck {
  ...
  **/
   ...
   * @return the VOIEPaystubReportAck instance itself
   */
  public VOIEPaystubReportAck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, voIEPaystubReportAck.title) &&
        Objects.equals(this.id, voIEPaystubReportAck.id) &&
        ...
        Objects.equals(this.additionalProperties, voIEPaystubReportAck.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VOIEPaystubReportAck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VOIEPaystubReportAck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VOIEPaystubReportAck is not found in the empty JSON string", VOIEPaystubReportAck.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VOIEPaystubReportAck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VOIEPaystubReportAck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VOIEPaystubReportAck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VOIEPaystubReportAck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VOIEPaystubReportAck.class));

       return (TypeAdapter<T>) new TypeAdapter<VOIEPaystubReportAck>() {
           @Override
           public void write(JsonWriter out, VOIEPaystubReportAck value) throws IOException {
           ...
           @Override
           public VOIEPaystubReportAck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VOIEPaystubReportAck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VOIEPaystubReportAck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VOIEPaystubReportAck
  * @throws IOException if the JSON string is invalid with respect to VOIEPaystubReportAck
  */
  public static VOIEPaystubReportAck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VOIEPaystubReportAck.class);
  }

 /**
  * Convert an instance of VOIEPaystubReportAck to an JSON string
  *
  * @return JSON string
  */
