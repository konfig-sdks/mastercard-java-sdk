...
public class AccountDetailsTxBased {
  ...
  public AccountDetailsTxBased interestMarginBalance(Double interestMarginBalance) {
  ...
  public AccountDetailsTxBased interestMarginBalance(Integer interestMarginBalance) {
  ...
  **/
  ...
  public AccountDetailsTxBased availableCashBalance(Double availableCashBalance) {
  ...
  public AccountDetailsTxBased availableCashBalance(Integer availableCashBalance) {
  ...
  **/
  ...
  public AccountDetailsTxBased vestedBalance(Double vestedBalance) {
  ...
  public AccountDetailsTxBased vestedBalance(Integer vestedBalance) {
  ...
  **/
  ...
  public AccountDetailsTxBased currentLoanBalance(Double currentLoanBalance) {
  ...
  public AccountDetailsTxBased currentLoanBalance(Integer currentLoanBalance) {
  ...
  **/
  ...
  public AccountDetailsTxBased availableBalanceAmount(Double availableBalanceAmount) {
  ...
  public AccountDetailsTxBased availableBalanceAmount(Integer availableBalanceAmount) {
  ...
  **/
  ...
  public AccountDetailsTxBased marginBalance(Double marginBalance) {
  ...
  public AccountDetailsTxBased marginBalance(Integer marginBalance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100", value = "Net interest earned after deducting interest paid out")
  ...
  public AccountDetailsTxBased currentBalance(Double currentBalance) {
  ...
  public AccountDetailsTxBased currentBalance(Integer currentBalance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000", value = "Current balance")
   ...
   * @return the AccountDetailsTxBased instance itself
   */
  public AccountDetailsTxBased putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interestMarginBalance, accountDetailsTxBased.interestMarginBalance) &&
        ...
        Objects.equals(this.additionalProperties, accountDetailsTxBased.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(interestMarginBalance, availableCashBalance, vestedBalance, currentLoanBalance, availableBalanceAmount, marginBalance, currentBalance, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountDetailsTxBased
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountDetailsTxBased.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountDetailsTxBased is not found in the empty JSON string", AccountDetailsTxBased.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountDetailsTxBased.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountDetailsTxBased' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountDetailsTxBased> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountDetailsTxBased.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountDetailsTxBased>() {
           @Override
           public void write(JsonWriter out, AccountDetailsTxBased value) throws IOException {
           ...
           @Override
           public AccountDetailsTxBased read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountDetailsTxBased instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountDetailsTxBased given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountDetailsTxBased
  * @throws IOException if the JSON string is invalid with respect to AccountDetailsTxBased
  */
  public static AccountDetailsTxBased fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountDetailsTxBased.class);
  }

 /**
  * Convert an instance of AccountDetailsTxBased to an JSON string
  *
  * @return JSON string
  */
