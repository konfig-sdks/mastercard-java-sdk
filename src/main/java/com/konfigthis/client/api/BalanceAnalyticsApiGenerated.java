...
public class BalanceAnalyticsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BalanceAnalyticsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public BalanceAnalyticsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call generateAnalyticsReportCall(String customerId, BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints, String referenceNumber, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/analytics/balance/v1/customer/{customerId}"
    ...
    private okhttp3.Call generateAnalyticsReportValidateBeforeCall(String customerId, BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints, String referenceNumber, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling generateAnalyticsReport(Async)");
        }
        ...
        if (balanceAndCashFlowAnalyticsReportConstraints == null) {
            throw new ApiException("Missing the required parameter 'balanceAndCashFlowAnalyticsReportConstraints' when calling generateAnalyticsReport(Async)");
        }

        return generateAnalyticsReportCall(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber, _callback);

    }


    private ApiResponse<ObbAnalyticsReportAck> generateAnalyticsReportWithHttpInfo(String customerId, BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints, String referenceNumber) throws ApiException {
        okhttp3.Call localVarCall = generateAnalyticsReportValidateBeforeCall(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber, null);
        Type localVarReturnType = new TypeToken<ObbAnalyticsReportAck>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call generateAnalyticsReportAsync(String customerId, BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints, String referenceNumber, final ApiCallback<ObbAnalyticsReportAck> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateAnalyticsReportValidateBeforeCall(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber, _callback);
        Type localVarReturnType = new TypeToken<ObbAnalyticsReportAck>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GenerateAnalyticsReportRequestBuilder {
        private final String customerId;
        private List<Long> accountIds;
        private Integer lengthOfReport;
        private String referenceNumber;

        private GenerateAnalyticsReportRequestBuilder(String customerId) {
         ...
         * @return GenerateAnalyticsReportRequestBuilder
         */
        public GenerateAnalyticsReportRequestBuilder accountIds(List<Long> accountIds) {
         ...
         * @return GenerateAnalyticsReportRequestBuilder
         */
        public GenerateAnalyticsReportRequestBuilder lengthOfReport(Integer lengthOfReport) {
         ...
         * @return GenerateAnalyticsReportRequestBuilder
         */
        public GenerateAnalyticsReportRequestBuilder referenceNumber(String referenceNumber) {
            this.referenceNumber = referenceNumber;
            return this;
        }
        
        /**
         * Build call for generateAnalyticsReport
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Response given when balance analytics were generated successfully, providing the caller with a report ID which can be used to retrieve the report as JSON or a PDF. </td><td>  -  </td></tr>
         </table>
         */
        ...
        /**
         * Execute generateAnalyticsReport request
        ...
        public ObbAnalyticsReportAck execute() throws ApiException {
            BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints = buildBodyParams();
            ApiResponse<ObbAnalyticsReportAck> localVarResp = generateAnalyticsReportWithHttpInfo(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute generateAnalyticsReport request with HTTP info returned
        ...
        public ApiResponse<ObbAnalyticsReportAck> executeWithHttpInfo() throws ApiException {
            BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints = buildBodyParams();
            return generateAnalyticsReportWithHttpInfo(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber);
        }

        /**
         * Execute generateAnalyticsReport request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ObbAnalyticsReportAck> _callback) throws ApiException {
            BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints = buildBodyParams();
            return generateAnalyticsReportAsync(customerId, balanceAndCashFlowAnalyticsReportConstraints, referenceNumber, _callback);
        }
    }
     ...
     */
    public GenerateAnalyticsReportRequestBuilder generateAnalyticsReport(String customerId) throws IllegalArgumentException {
        if (customerId == null) throw new IllegalArgumentException("\"customerId\" is required but got null");
            

        return new GenerateAnalyticsReportRequestBuilder(customerId);
    }
    private okhttp3.Call generateFcraAnalyticsReportCall(String customerId, BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints, String referenceNumber, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/analytics/balance/v1/customer/{customerId}/fcra"
            .replace("{" + "customerId" + "}", localVarApiClient.escapeString(customerId.toString()));
    ...
    public class GenerateFcraAnalyticsReportRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> Response given when balance analytics (FCRA) were generated successfully, providing the caller with a report ID which can be used to retrieve the report as JSON or a PDF. </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            BalanceAndCashFlowAnalyticsReportConstraints balanceAndCashFlowAnalyticsReportConstraints = buildBodyParams();
    ...
    private okhttp3.Call generateReportCall(String customerId, String userType, AnalyticsReportConstraints analyticsReportConstraints, String callbackUrl, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/decisioning/v2/customers/{customerId}/reports/balance-analytics/userTypes/{userType}"
            .replace("{" + "customerId" + "}", localVarApiClient.escapeString(customerId.toString()))
