...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.finicityAppKey != null) {
                this.setFinicityAppKey(configuration.finicityAppKey);
            }
            if (configuration.finicityAppToken != null) {
                this.setFinicityAppToken(configuration.finicityAppToken);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getFinicityAppKey() {
        return ((ApiKeyAuth) this.getAuthentication("FinicityAppKey")).getApiKey();
    }

    public void setFinicityAppKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("FinicityAppKey")).setApiKey(apiKey);
    }

    public void setFinicityAppKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("FinicityAppKey")).setApiKeyPrefix(prefix);
    }
    public String getFinicityAppToken() {
        return ((ApiKeyAuth) this.getAuthentication("FinicityAppToken")).getApiKey();
    }

    public void setFinicityAppToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("FinicityAppToken")).setApiKey(apiKey);
    }

    public void setFinicityAppTokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("FinicityAppToken")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.16.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.finicity.com)
